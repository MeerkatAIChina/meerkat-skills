...
metadata:
  hermes:
    tags: [marketing, partnerships, co-marketing]
    related_skills: []
---
...
**🛑 Confirmation Gate**: Before moving to campaign brainstorming, present your top 3-5 scored partners and ask the user: *"Do these partner picks look right? Which 1-2 should we prioritize for outreach?"* Do not proceed until the user confirms the shortlist.
...
**🛑 Confirmation Gate**: Before drafting outreach or planning logistics, present 2-3 campaign ideas tailored to the confirmed partner and ask: *"Which of these campaign ideas resonates most? Should we lead with that one?"* Wait for user selection before moving to outreach.
...
**🛑 Confirmation Gate**: Before the user sends outreach or schedules a partner call, confirm: *"Does this outreach message feel authentic to your brand? Are the campaign ideas and call prep items aligned with your goals?"* Adjust based on feedback before finalizing.
...
### When the User Provides Minimal Input

If the user says only "find me partners" without context:

1. **Ask the essentials first** — don't start brainstorming blind:
   - "To find the right partners, I need to know: What does your product do? Who is your ideal customer?"
   - "Do you have any existing integration partners or tools your customers commonly use alongside yours?"
2. **If they still provide nothing**, suggest checking for `.agents/product-marketing-context.md` and ask if they can share their website URL so you can infer their product category.
3. **Fallback**: Explain that without product context, partner recommendations will be generic and less actionable.

### When No Suitable Partners Are Found

1. **Broaden the search criteria** — revisit the partner identification framework with looser constraints:
   - Expand from "adjacent in workflow" to "same buyer persona, any problem"
   - Consider partners in adjacent industries with similar ICP
   - Look at larger or smaller companies (relax stage/size match)
2. **If still no matches**, suggest the user:
   - Survey customers directly: "What other tools do you use?"
   - Check G2/Capterra category neighbors for overlooked options
   - Consider very early-stage partnerships with smaller but highly aligned companies

### When Outreach Receives No Response

1. **Follow up once** after 5-7 business days with a shorter, value-forward message
2. **Try a different contact** at the same company (partnerships team, marketing lead, or founder for smaller companies)
3. **Pivot to lower-commitment asks**: instead of a formal co-marketing campaign, propose a simple content swap, social cross-promotion, or guest blog post
4. **If no response after two attempts**, deprioritize and move to the next partner on the scored list

### When Audience Data Is Unavailable

1. **Without Crossbeam/Reveal access**, estimate overlap using:
   - LinkedIn Sales Navigator: search shared companies/roles
   - Analyze mutual social media followers
   - Check if you sponsor the same podcasts or conferences
2. **If you have zero audience data**, use the partner scoring framework qualitatively based on public information (social following, website traffic estimates, community activity)

### When the User Has No Existing Partnerships Experience

1. **Start with the lowest-effort format** from the campaign types tables (e.g., co-authored blog post, guest newsletter swap, social media takeover)
2. **Provide the cold outreach template** and offer to help customize it
3. **Walk through the simple co-marketing agreement outline** step by step
4. **Set expectations**: first partnerships are about learning the process; metrics may be modest
