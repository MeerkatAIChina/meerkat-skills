...
description: "Identifies high-quality leads for your product or service by analyzing your business, searching for target companies, and providing actionable contact strategies. For sales, business development, and marketing professionals."
metadata:
  version: 1.0.0
  author: MeerkatAIChina (sourced from ComposioHQ/awesome-claude-skills)
  license: MIT
  hermes:
    tags: [sales, lead-generation, business-development, prospecting]
    related_skills: [cold-email, icp-research, competitor-profiling, sales-enablement]
    optimized: true
