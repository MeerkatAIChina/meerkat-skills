...
description: "Analyzes meeting transcripts to uncover behavioral patterns, communication insights, and actionable feedback. Identifies conflict avoidance, filler words, conversation dominance, and missed listening opportunities. For professionals seeking to improve communication and leadership skills."
metadata:
  version: 1.0.0
  author: MeerkatAIChina (sourced from ComposioHQ/awesome-claude-skills)
  license: MIT
  hermes:
    tags: [consulting, communication, leadership, meeting-analysis]
    related_skills: [pro-report-builder, sales-enablement, customer-journey-mapping]
    optimized: true
    optimized_date: 2026-05-13
---
