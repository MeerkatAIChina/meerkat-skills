...
**Before proceeding to Phase 1, verify context completeness:**

### Missing Context Protocol
- If any of the 5 intake dimensions (Goal, Industry, Stage, Role, Geography) are missing → prompt user with the structured intake template. **Do not proceed without all 5.**
- If company context or newsletter goal is ambiguous → ask: *"Is this primarily for lead generation or thought leadership? The structure changes significantly based on this choice."*
- If prior issues are referenced but not provided → note: *"Operating without prior issue context. Voice consistency will be based on industry defaults unless corrected."*

### Edge Cases
- **No ICP defined:** Default to "B2B buyers in [Industry]" and flag for user review before finalizing.
- **Mixed geography audience:** Default to US-first conventions with a note: *"Regional examples can be swapped for your secondary geography."*
- **Employee-led newsletter without approval clarity:** Assume approval IS required and add the checkpoint. Safer to include and remove later than to skip.
- **Quick mode requested but context incomplete:** Still require all 5 intake dimensions — the outline must be grounded in real context.
- **Conflicting goals** (e.g., lead gen AND thought leadership): Ask user to prioritize one as primary. Structure for primary; secondary can be addressed in CTA only.
- **No industry match:** If the user's industry doesn't fit the four templates (Sales Tech, HR Tech, Fintech, Ops Tech), default to Ops Tech (practical tone) and flag for customization.
...
## Industry-Specific Strategy Guide

*(Previously referenced external PLAYBOOK.md — now inline)*

### Sales Tech Strategy
- **Tone:** Data-heavy, metrics-driven, pipeline-focused
- **Subject line style:** Lead with numbers ("3 benchmarks...", "47% of reps...")
- **Core insight:** Tie every insight to revenue impact or pipeline efficiency
- **Playbook style:** CRM workflows, sequence optimization, tool comparisons
- **CTA:** Trial, demo, benchmark download
- **Pitfall:** Avoid generic "sales tips" — this audience has seen them all

### HR Tech Strategy
- **Tone:** Research-led, evidence-based, people-first language
- **Subject line style:** Lead with outcomes ("How [Company] reduced churn by...")
- **Core insight:** Cite studies, surveys, or named frameworks (e.g., Gallup, SHRM)
- **Playbook style:** Implementation roadmaps, change management steps
- **CTA:** Assessment, consultation, case study
- **Pitfall:** Don't over-index on technology — balance with human impact

### Fintech Strategy
- **Tone:** Compliance-aware, precise, risk-conscious
- **Subject line style:** Avoid hype; favor specificity ("Regulatory update: what changed in Q2")
- **Core insight:** Always include regulatory context and risk framing
- **Playbook style:** Checklists with compliance gates, decision frameworks
- **CTA:** Compliance audit, security review, integration guide
- **Pitfall:** Never make unqualified claims — add "based on current guidance, consult your compliance team"

### Operations Tech Strategy
- **Tone:** Practical, process-oriented, ROI-focused
- **Subject line style:** Lead with efficiency gains ("Cut [process] time by 40% with...")
- **Core insight:** Focus on workflow transformation, not just tool features
- **Playbook style:** Step-by-step SOPs, before/after process maps
- **CTA:** Process audit, workflow template, implementation checklist
- **Pitfall:** Avoid feature dumps — always connect to operational outcome

### Cross-Cutting: Role Approvals & Geography

**Role-Based Approval Gates:**
| Role | Approval Required? | Checkpoint |
|------|-------------------|------------|
| Founder | Usually no | Confirm if any investor/board review needed |
| VP/Director | Sometimes | Check if brand/marketing team reviews external content |
| PMM/Content | Usually yes | Manager or brand team approval before publishing |
| Enterprise employee | Always yes | Legal, compliance, and manager — build 5 business days for review |

**Geography Timing & Tone:**
| Geography | Send Window | Tone Adjustments |
|-----------|------------|-------------------|
| US-first | Tue-Thu, 6-10am EST/PST | US benchmarks, US case studies, imperial units |
| India-first | Tue-Thu, 9-11am IST | Local examples, INR/market context, Indian business norms |
