...
## 来源
本 Skill 由 Agency Agents 项目（msitarzewski/agency-agents）的 **solidity-smart-contract-engineer** agent 转换而来。
转换日期: 2026-06-02
原始分类: engineering
...
*Registry: manufacturing-ai-efficiency-Skill | Skill ID: solidity-smart-contract-engineer*
