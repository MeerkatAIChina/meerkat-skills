...
description: "Assists in writing high-quality content by conducting research, adding citations, improving hooks, iterating on outlines, and providing real-time section-by-section feedback. Turns solo writing into a collaborative partnership while preserving your unique voice."
metadata:
  version: 1.0.0
  author: MeerkatAIChina (sourced from ComposioHQ/awesome-claude-skills)
  license: MIT
  hermes:
    tags: [content-marketing, writing, research, thought-leadership]
    related_skills: [content-strategy, copywriting-frameworks, brand-voice-guidelines, de-ai-ify]
    optimized: true
