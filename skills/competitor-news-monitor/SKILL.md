...
description: "When the user wants to watch named competitors or companies for material news on an ongoing basis and get a cited digest — funding rounds, product launches, pricing changes, partnerships, executive moves, regulatory filings, or incidents. Also use when the user mentions 'monitor these competitors weekly,' 'competitor intelligence digest,' 'tell me when Company X changes pricing or launches a product,' 'competitor watch,' 'track funding,' 'competitive monitoring,' 'market signal alerts,' or 'what changed at [company] this week.' Applies company-news categories, source hierarchy, event deduplication, and business-materiality scoring, and reports only material, new developments with primary-source evidence — staying silent when nothing material happened. For one-off company research, use web search directly; for feed reading, use watchers or research-digest."
metadata:
  hermes:
    compatible: true
    category: research
