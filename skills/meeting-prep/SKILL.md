---
name: meeting-prep
description: Generate a pre-meeting prep brief. Researches participants, pulls vault context, builds agenda, surfaces sharp questions. Use when prepping for sales calls, consulting meetings, partnership discussions, or interviews.
version: 1.0.0
author: BrianRWagner
license: MIT
metadata:
