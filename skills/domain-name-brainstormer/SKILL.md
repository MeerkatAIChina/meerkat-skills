...
description: "为项目生成创意域名并跨多个 TLD（.com、.io、.dev、.ai 等）检查可用性。适用于品牌命名、产品发布、公司注册、个人品牌建设等场景。节省数小时的头脑风暴和手动查询时间。"
license: MIT
author: Ben Aiad (inspired by Lenny's Newsletter use case)
metadata:
  version: 1.0.0
  category: strategy
  domain: branding
  ...
  hermes:
    ...
    domain: branding-naming
    toolsets: ["web"]
    platforms: ["claude-code", "hermes-agent", "openclaw", "codex-cli"]
---
